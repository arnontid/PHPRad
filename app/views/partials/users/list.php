                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td>
                                                        <a  data-source='<?php echo json_encode_quote(Menu :: $name); ?>' 
                                                            ...
                                                            data-url="<?php print_link("users/editfield/$data[id]"); ?>" 
                                                            data-name="name" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-success has-tooltip" title="View Record" href="<?php print_link('users/view/'.$data['id']); ?>">
                                                            <i class="fa fa-eye"></i> 
                                                        </a>
                                                        
                                                        
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link('users/edit/'.$data['id']); ?>">
                                                            <i class="fa fa-edit"></i> 
                                                        </a>
                                                        
                                                        
                                                        <a class="btn btn-sm btn-danger recordDeletePromptAction has-tooltip" title="Delete this record" href="<?php print_link("users/delete/$data[id]/?csrf_token=$csrf_token"); ?>" >
                                    ...
                                    <div class="">
                                        <div class="row">   
                                            <div class="col-sm-4">  
                                                ...
                                                <button data-prompt-msg="Are you sure you want to delete these records" data-url="<?php print_link("users/delete/{sel_ids}/?csrf_token=$csrf_token"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
